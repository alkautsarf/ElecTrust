...
const GlassNavigation = () => {
  ...
  const handleMouseMove = ({ offsetX, offsetY, target }:any) => {
    // @ts-ignore
...
const GlassLink = ({ text }:any) => {
  return (
    ...
    >
      <span className="relative z-10 text-black/90 transition-colors group-hover:text-white">
        {text}
      </span>
